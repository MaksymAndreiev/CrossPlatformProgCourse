...
public class SAXSaveVal {
    ...
    public static DataSheet XMLReadData() {
        ...
        try {
            ...
            System.out.println("SAXParser schema: " + saxParser.getSchema().getClass().getSimpleName());
    ...
    public static void main(String[] args){
        DataSheet dsh = SAXSaveVal.XMLReadData();
        System.out.println(dsh);
        DataAnalyzer da = new DataAnalyzer();
        da.setDatasheet(dsh);
        da.Analyze();
        System.out.println(da);
        DataSheetToXML.saveXMLDoc(DataSheetToXML.createDataSheetDOM(da), "task1/SAXAnalyze.xml");
    }
}
